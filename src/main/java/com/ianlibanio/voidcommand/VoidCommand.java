...
import com.ianlibanio.voidcommand.controller.impl.ValidSubCommandCommandImpl;
...
public abstract class VoidCommand extends org.bukkit.command.Command {
    ...
    private final ISubCommandController<String, Sub> validController = new ValidSubCommandCommandImpl();
